	...
	<fieldset>
			...
			<div>
				...
				<select onchange="onCommandChanged(this.value)">
					...
					<option data-cmd-name="setNodeDeviceType"></option>
				</select>
			</div>
		...
		<div>
			...
			<!-- set Node device type -->
			<div id="cmdiv_setNodeDeviceType" style="display:none;">
				<div><label data-text="TitleCmdParameters">Parameters</label>:<label data-text="SetNodeDeviceTypeDscp"></label></div>
				<div><label class="narrowleftcolumn" data-text="AreaID"></label><input data-param-verify="int,0,11" data-param-name="network"/><label>[0,11]</label></div>
				<div><label class="narrowleftcolumn" data-text="NodeID"></label><input data-param-verify="int,0,15" data-param-name="node"/><label>[0,15]</label></div>
			<div>
				<label class="narrowleftcolumn" data-text="ParamValidTypes"></label>
				<select data-param-verify="none" data-param-name="option">
				...
				<input class="default_button" data-text="Execute" onclick="executeUdpCmd(this, 'setNodeDeviceType', ['network','node','option'], refreshAfterDone)" type="button"/>
			</div>
